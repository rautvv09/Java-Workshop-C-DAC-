...
public class Window extends JFrame{
	...
	public Window() {
		 ...
		 num1TextField.setBounds(200, 50, 200, 30);
		 this.add(num1TextField);
		 
		 num2Label=new JLabel("Num 2:");
		 num2Label.setBounds(100, 100, 100, 30);
		 this.add(num2Label);
		 
		 num2TextField=new JTextField();
		 num2TextField.setBounds(200, 100, 200, 30);
		 ...
		 subButton.setBounds(250, 200, 100, 30);
		 this.add(subButton);
		 
		 mulButton=new JButton("MULTIPLY");
		 mulButton.setBounds(400, 200, 100, 30);
		 this.add(mulButton);
		 ...
		 ActionListener listener=(e) ->{
			 try {
				 ...
				 if(e.getSource()==addButton) {
					 result=num1+num2;
					 JOptionPane.showConfirmDialog(this, "Addition :"+result);
				 }
				 else if(e.getSource()==subButton) {
					 result=num1-num2;
					 JOptionPane.showConfirmDialog(this, "Subtraction :"+result);
				 }
				 else if(e.getSource()==mulButton) {
					 result=num1*num2;
					 JOptionPane.showConfirmDialog(this,"Multiplication :"+result);
				 }	 
			 }
			 catch(Exception ee) {
