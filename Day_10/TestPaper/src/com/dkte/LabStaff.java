...
public class LabStaff extends Staff {
	...
	public LabStaff acceptLab(Scanner sc) throws StaffException{
		...
		salary = sc.nextInt();
		if(salary<0) {
			 throw new StaffException("Salary Must Be Non-Negative Number");
		}

		return new LabStaff(id, name,salary);
